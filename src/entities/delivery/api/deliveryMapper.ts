...
export type ZoneDto = { id?: number; point_id: number; point_name?: string; streets?: StreetDto[]; geometry?: GeometryDto | unknown; coordinates?: unknown }; export type ValidationDto = { valid?: boolean; city_id?: number; street?: string; home?: string; entrance?: string; code?: string };
...
export const mapValidation = (value: ValidationDto): AddressValidation => ({ valid: Boolean(value.valid), cityId: value.city_id == null ? undefined : Number(value.city_id), street: value.street, home: value.home, entrance: value.entrance, code: value.code });
