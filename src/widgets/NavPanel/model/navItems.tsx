...
export const navItems: NavItem[] = [
  { label: 'Оформить заказ', href: '/order-new', icon: <WriteIcon /> },
  { label: 'Клиенты', href: '/clients', icon: <ClientsIcon /> },
  { label: 'Все заказы', href: '/orders', icon: <OrdersIcon /> },
  { label: 'Заказы на кухне', href: '/kitchen', icon: <KitchenIcon /> },
  { label: 'Карта доставки', href: '/delivery-map', icon: <MapIcon /> },
];
